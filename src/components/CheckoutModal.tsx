  ...
  return (
    <div className="fixed inset-0 z-[120] flex items-end md:items-center justify-center bg-black/60 backdrop-blur-md p-0 md:p-4">
      ...
      <motion.div
        ...
        className="relative bg-white dark:bg-[#141022] w-full md:max-w-md max-h-[95vh] md:max-h-[90vh] flex flex-col overflow-hidden shadow-2xl border border-white/10 rounded-t-[2.5rem] md:rounded-[2.5rem] touch-none md:touch-auto"
      >
        ...
        <div className="relative flex items-center px-6 py-5 border-b border-gray-100 dark:border-gray-800">
          ...
          <button
            onClick={onClose}
            className="absolute right-6 w-10 h-10 flex items-center justify-center bg-gray-100 dark:bg-gray-800 hover:bg-gray-200 dark:hover:bg-gray-700 text-gray-500 dark:text-gray-400 rounded-full transition-colors"
          >
        ...
        <div className="p-6 bg-gray-50 dark:bg-white/5 border-t border-gray-100 dark:border-gray-800 pb-10 md:pb-6">
          <button className="w-full h-14 bg-[#6d3ff8] text-white rounded-2xl font-bold flex items-center justify-center gap-3 shadow-lg hover:bg-[#5b32d1] transition-colors">
            FINALIZAR COMPRA
