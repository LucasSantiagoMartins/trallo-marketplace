...
interface TralloButtonProps {
  ...
  variant?: "primary" | "secondary" | "outline" | "social" | "gray";
  icon?: string;
...
const TralloButton: React.FC<TralloButtonProps> = ({
  ...
  const variants = {
    ...
    outline:
      "bg-transparent text-primary border-2 border-primary lg:hover:bg-primary/10",
    social:
      "bg-card border border-border lg:hover:bg-muted text-foreground text-sm font-semibold",
    gray: "bg-gray-100 dark:bg-white/10 text-gray-700 dark:text-gray-200 lg:hover:bg-gray-200 dark:lg:hover:bg-white/20",
  };
