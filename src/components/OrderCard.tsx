      ...
      <div className="bg-white dark:bg-white/5 rounded-2xl p-5 shadow-sm border border-gray-100 dark:border-white/10 hover:border-[#6d3ff8]/30 transition-all duration-300">
        <div className="flex items-center justify-between mb-4">
          <div className="flex items-center gap-2 sm:gap-3">
            <div className="size-10 sm:size-14 rounded-xl bg-gray-100 dark:bg-white/10 flex items-center justify-center overflow-hidden border border-gray-200 dark:border-white/5">
              <span className="material-symbols-outlined text-gray-400 text-xl sm:text-2xl">
                shopping_bag
              </span>
            </div>
            <div>
              <h3 className="font-bold text-sm sm:text-base leading-tight text-gray-900 dark:text-white">
                {order.orderNumber}
              </h3>
          ...
          <div
            className={`${getOrderStatusColor(order.status)} px-3 sm:px-4 py-1.5 rounded-full flex items-center justify-center ml-auto flex-shrink-0`}
          >
            <span className="text-[9px] sm:text-[10px] font-black uppercase tracking-tight sm:tracking-wider whitespace-nowrap">
        ...
        <div className="flex gap-2">
          {active && order.status === OrderStatus.SHIPPED && (
            <button
              ...
              className="flex-[2] bg-[#6d3ff8] text-white font-bold py-3 rounded-xl flex items-center justify-center gap-2 text-sm shadow-lg shadow-[#6d3ff8]/25 hover:bg-[#5a32d1] transition-all"
            >
