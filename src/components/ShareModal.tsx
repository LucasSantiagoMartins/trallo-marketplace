      ...
      >
        ...
        <div className="grid grid-cols-4 gap-4 px-2">
          {shareOptions.map((option) => {
            ...
            const showCheck = isCopyBtn && isCopied;
              ...
              >
                <div
                  className={`size-14 rounded-full flex items-center justify-center shadow-lg text-white transition-all duration-300
                    ${showCheck ? "bg-green-500 scale-110" : option.color}
                    active:scale-90`}
                >
                  {showCheck ? (
                    <svg
                ...
                <span
                  className={`text-[10px] font-semibold text-center transition-colors ${showCheck ? "text-green-600 dark:text-green-500" : "text-zinc-700 dark:text-zinc-300"}`}
                >
                  {showCheck ? "Copiado" : option.name}
                </span>
              </button>
            );
          })}
