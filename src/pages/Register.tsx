  ...
  return (
    <MobileLayout className="pb-10">
      ...
      <div className="flex flex-col px-6 pt-12 pb-6">
        ...
        <h1 className="text-foreground text-4xl clash-style leading-none mb-2">
          Criar Conta
        </h1>
      ...
      <div className="px-6 mb-8">
        ...
        <div className="grid grid-cols-2 gap-4">
          <label className="relative cursor-pointer group">
            ...
            />
            <div className="flex flex-col items-center justify-center p-5 rounded-xl border-2 border-border bg-card transition-all peer-checked:border-primary peer-checked:bg-primary/5">
