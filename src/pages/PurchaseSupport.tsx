    ...
    <div className="bg-white text-[#0f172a] min-h-screen selection:bg-[#6c3ef8]/20 relative">
      ...
      <main className="pt-24 pb-32 px-6 max-w-6xl mx-auto space-y-12">
        <section className="text-center space-y-6">
          ...
          {!hasResults && (
            <p className="text-base md:text-[14px] text-slate-600 max-w-2xl mx-auto font-medium animate-in fade-in duration-500">
            ...
            <div className="flex items-center gap-2">
              ...
              >
                <span className="hidden md:inline">
                  {hasResults ? "Recalcular" : "Usar Agora"}
                </span>
        ...
        {hasResults ? (
          <PurchaseResults data={recommendations} />
        ) : (
          <section className="space-y-6 w-full animate-in fade-in duration-700">
            <div className="text-left space-y-1">
              <h2 className="text-lg md:text-xl font-bold text-slate-900">
                Como Funciona
              </h2>
              <p className="text-slate-500 text-xs md:text-sm font-medium">
                Veja em menos de 1 minuto como o TRALLO facilita as suas
                compras.
              </p>
            </div>
