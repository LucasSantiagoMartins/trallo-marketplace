...
const CreateProduct: React.FC = () => {
  ...
  return (
    <MobileLayout className="pb-32">
      {/* Header */}
      <header className="sticky top-0 z-50 bg-background/80 backdrop-blur-md px-4 py-4 flex items-center justify-between max-w-[430px] mx-auto">
        <button
          onClick={() => navigate(-1)}
      ...
      <main className="px-4 space-y-4">
        ...
        {/* Basic Info Card */}
        <section className="bg-card rounded-xl p-4 shadow-sm space-y-4">
          <div>
        ...
        {/* Taxonomy Card */}
        <section className="bg-card rounded-xl p-4 shadow-sm space-y-3">
        ...
        {/* Pricing Card */}
        <section className="bg-card rounded-xl p-6 shadow-sm border-2 border-primary/10">
          ...
          <div className="flex items-center justify-center gap-3">
            ...
            <input
              ...
              placeholder="0.00"
              step="0.01"
              className="font-grotesk text-4xl font-bold bg-transparent border-none focus:ring-0 text-center w-full max-w-[200px] placeholder:text-muted-foreground"
            />
          </div>
        ...
        <section
          ...
          className="bg-gradient-to-br from-primary to-primary/70 rounded-xl p-4 shadow-lg text-primary-foreground flex items-center justify-between cursor-pointer"
        >
          <div className="flex items-center gap-4">
            ...
            <div>
              <h4 className="font-bold text-sm">Vender mais rápido?</h4>
              <p className="text-xs text-primary-foreground/80">Destaque o seu anúncio hoje.</p>
            </div>
          </div>
          <div
      ...
      {/* Sticky Footer CTA */}
      <footer className="fixed bottom-0 left-0 right-0 p-4 bg-background/90 backdrop-blur-xl border-t border-border max-w-[430px] mx-auto">
        <button
